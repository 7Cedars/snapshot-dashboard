...
export default function ComboBox() {
  ...
  return (
    <div className="col-span-5 items-center w-full grid border" > 
      <Combobox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <div className="relative px-2 text-gray-400 cursor-default overflow-hidden rounded-r-lg border bg-white text-left sm:text-sm">
            Search DAOs by name:  
            <Combobox.Input
              className=" border-none text-sm leading-5 text-gray-900 focus:ring-0" //  py-2 pl-3 pr-10
