...
// clone from: https://codesandbox.io/s/react-double-slider-with-colors-and-labels-forked-stt73?file=/src/App.js:0-2021
...
export const Slider = ({ min, max }: Props) => {
  ...
  return (
    ...
    >
      ...
      <input
        id="min"
        className="min shadow-md rounded-l-lg"
        style={styles.min}
        name="min"
        type="range"
        step="1"
